...
new_elect$Voltage =  as.numeric(as.character(new_elect$Voltage))
new_elect$Global_reactive_power =  as.numeric(as.character(new_elect$Global_reactive_power))
...
#plot2()
plot(new_elect$Time, new_elect$Voltage, type="l",
...
#plot 4
plot(new_elect$Time, new_elect$Global_reactive_power, type="l",
